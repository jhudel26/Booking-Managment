          ...
          {admins.map((admin) => (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                ...
                <div className="flex items-center justify-between space-x-2">
                  <Label htmlFor={`grant-permissions-${admin.id}`} className="flex flex-col space-y-1">
                  ...
                  <Switch
                    id={`grant-permissions-${admin.id}`}
                    checked={admin.can_grant_admin_permissions}
                    disabled={updating === admin.id || admin.role === "super_admin"}
                    onCheckedChange={(checked) =>
                      updatePermission(admin.id, { ...admin, can_grant_admin_permissions: checked })
                    }
                  />
                </div>
